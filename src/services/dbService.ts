...
class DBService {
  ...
  private mapSupabaseProject(p: any): any {
    return {
      ...
      siteContactName: p.contact_person || '',
      siteContactPhone: p.phone || '',
      status: p.status,
    ...
    async getSummary(dateFrom?: string, dateTo?: string): Promise<ReportSummary[]> {
      ...
      return reports.flatMap((r: any) => {
        ...
        summaries.push({
          ...
          financialAgreement: project?.financialAgreement,
          ...
          exportStatus: r.exportStatus || 'new',
          notes: r.notes || '',
          description: r.description,
        ...
        additionalWorkers.forEach((aw: any, idx: number) => {
          ...
          summaries.push({
            ...
            exportStatus: r.exportStatus || 'new',
            notes: r.notes || '',
            description: aw.description || r.description,
            revenue: awFinancials.revenue,
            hourlyRevenue: isReportInternal ? 0 : sellingPrice,
