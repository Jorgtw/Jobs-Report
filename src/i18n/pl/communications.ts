...
export const communications = {
  ...
  push_banner_title: 'Włącz powiadomienia push',
  push_banner_desc: 'Otrzymuj aktualizacje w czasie rzeczywistym, nawet gdy aplikacja jest zamknięta.',
  push_activate: 'Włącz teraz',
  push_dismiss: 'Nie teraz',
  push_enabled: 'Powiadomienia włączone!',
  push_settings_title: 'Ustawienia powiadomień',
  push_notifications: 'Powiadomienia Push',
  push_status_active: 'Powiadomienia Aktywne',
  push_status_blocked: 'Brak uprawnień',
  push_status_disabled: 'Wyłączone przez użytkownika',
