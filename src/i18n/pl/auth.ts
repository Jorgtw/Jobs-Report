export const auth = {
  ...
  usernameRules: "Od 3 do 64 znaków: litery łacińskie, cyfry, kropka, myślnik lub podkreślenie. Wybierz inną nazwę użytkownika dla każdej firmy.",
  languageLabel: "Język",
  quickSignupTitle: "Zacznij bezpłatnie z JobsReport",
  quickSignupDesc: "Wpisz nazwę firmy, nazwę użytkownika, e-mail i hasło.",
  freePlanReassurance: "Bezpłatnie do 5 użytkowników · Bez terminu ważności · Bez reklam · Bez karty kredytowej",
  emailLoginHint: "E-mail do wiadomości i odzyskiwania hasła. Możesz używać go dla kont w różnych firmach.",
  ...
  registrationExists: "Nazwa firmy lub użytkownika jest już zajęta. Wybierz inną.",
