export const auth = {
  ...
  quickSignupDesc: "Du skal kun bruge firmanavn, e-mail og en adgangskode.",
  freePlanReassurance: "Gratis op til 5 brugere · Ingen udløbsdato · Ingen reklamer · Intet kreditkort",
  emailLoginHint: "Du bruger denne e-mail til at logge ind.",
  ...
  registrationExists: "Virksomheden eller kontoen er allerede registreret. Log ind, eller brug oplysningerne for en ny virksomhed.",
