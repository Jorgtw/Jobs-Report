...
export const communications = {
  ...
  push_banner_title: 'Aktiver push-meddelelser',
  push_banner_desc: 'Modtag opdateringer i realtid, selv når appen er lukket.',
  push_activate: 'Aktiver nu',
  push_dismiss: 'Ikke nu',
  push_enabled: 'Meddelelser aktiveret!',
  push_settings_title: 'Beskedindstillinger',
  push_notifications: 'Push-meddelelser',
  push_status_active: 'Meddelelser aktive',
  push_status_blocked: 'Uautoriseret',
  push_status_disabled: 'Deaktiveret af brugeren',
