export const auth = {
  ...
  quickSignupDesc: "Just your company name, email and a password.",
  freePlanReassurance: "Free up to 5 users · No expiration · No ads · No credit card",
  emailLoginHint: "You will use this email to sign in.",
  ...
  registrationExists: "Company or account already registered. Sign in or use the details of a new company.",
