export const auth = {
  ...
  quickSignupDesc: "Bastano il nome della tua azienda, la tua email e una password.",
  freePlanReassurance: "Gratis fino a 5 utenti · Nessuna scadenza · Nessuna pubblicità · Nessuna carta di credito",
  emailLoginHint: "Userai questa email per accedere.",
  ...
  registrationExists: "Azienda o account già registrato. Accedi oppure usa i dati di una nuova azienda.",
