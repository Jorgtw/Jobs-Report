export const reports = {
  ...
  margin: "MARGINE",
  workValue: "VALORE LAVORO",
  valueCostDiff: "DIFFERENZA",
  adminStatusTitle: "Stato amministrativo",
  ...
  complianceSatisfactionDeclaration: "Soddisfatto del servizio svolto",
  expenseCantiere: "Spesa Cantiere",
  expenseRimborso: "Rimborso Personale",
  expenseKm: "Trasferta (KM)",
  kmDistance: "Distanza (KM)",
  hoursSummary: "Riepilogo Ore",
  ordinaryHours: "Ordinarie",
  extraHours: "Extra",
  nightHours: "Notturne",
  holidayHours: "Festive",
  totalHours: "Totale Ore",
  operativeCosts: "Costi Operativi",
  personnel: "Personale",
  materials: "Materiali",
  subcontracting: "Subappalti",
  ...
  cost: "Costo",
  value: "Valore",
  interventionReport: "Rapporto Intervento",
  generateInterventionReport: "Genera Rapporto Intervento",
  selectReportsForIntervention: "Seleziona i rapportini da includere",
  interventionDescription: "Descrizione Intervento",
  interventionFinalNotes: "Note Finali",
  interventionCompleted: "Intervento Concluso",
  workPeriod: "Periodo Lavori",
