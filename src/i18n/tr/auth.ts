export const auth = {
  ...
  quickSignupDesc: "Şirket adınız, e-postanız ve bir şifre yeterli.",
  freePlanReassurance: "5 kullanıcıya kadar ücretsiz · Süre sınırı yok · Reklam yok · Kredi kartı gerekmez",
  emailLoginHint: "Giriş yapmak için bu e-postayı kullanacaksınız.",
  ...
  registrationExists: "Şirket veya hesap zaten kayıtlı. Giriş yapın veya yeni bir şirketin bilgilerini kullanın.",
