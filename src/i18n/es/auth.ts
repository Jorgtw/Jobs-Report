export const auth = {
  ...
  quickSignupDesc: "Solo necesitas el nombre de tu empresa, tu email y una contraseña.",
  freePlanReassurance: "Gratis hasta 5 usuarios · Sin caducidad · Sin anuncios · Sin tarjeta de crédito",
  emailLoginHint: "Usarás este email para iniciar sesión.",
  ...
  registrationExists: "La empresa o la cuenta ya está registrada. Inicia sesión o utiliza los datos de una nueva empresa.",
